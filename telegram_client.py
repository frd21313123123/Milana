...
from milana.telegram_config import (
    AI_CONFIG_PATH,
    BASE_DIR,
    DEFAULT_AI_MODEL,
...
from milana.telegram_cli import (
    build_parser,
    display_name,
    message_text,
    normalize_target,
...
from milana.telegram_media import (
...
class GeminiQuotaFallbackClient:
    """Always try Gemini first and use OpenAI when its provider call fails."""
